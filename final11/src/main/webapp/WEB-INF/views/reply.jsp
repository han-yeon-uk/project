      ...
      <div id = "lightbox" style="overflow:hidden">
		<div style="float:left; left:0px; bottom:0px;  ">
            ...
            {{#each .}}
			 ...
			 <span id="btnUpdate" style="float:right;margin-right:20px;"></span>
               ...
               $("#image").attr("src",src);
                  $.ajax({
             		...
             		success:function(data){
						var temp = Handlebars.compile($("#temp").html());
						if (regexp === nick) {
							var srt = "<button id='reviewUpdate' style='background-color: transparent !important;border:none;' rcode="+ rcode+ " ccode="+ ccode+ ">수정</button>&nbsp;/&nbsp;";
								srt += "<button id='reviewDelete' rcode="+ rcode+ " style='background-color: transparent !important;border:none;'>삭제</button>"
								$("#btnUpdate").html(srt);
							} else {
								$("#btnUpdate").html("");
							}
